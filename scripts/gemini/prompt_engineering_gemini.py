...
few_shot_hindi_prompts = {
    "एक आदर्श छात्र के अंग्रेजी और इतिहास में सामर्थ्य का वर्णन करें।": "उदाहरण: एक आदर्श छात्र में जिज्ञासा, आलोचनात्मक सोच, और उत्कृष्ट संचार कौशल होते हैं।\n",
    ...
    "एक नर्स के सामान्य जिम्मेदारियों का वर्णन करें।": "उदाहरण: नर्स के काम मरीजों की देखभाल करना और उन्हें दवाएं देना होते हैं।\n",
...
def generate_and_save(prompts, language, technique_fn, technique_name):
    ...
    filename = f"results/gemini/prompt_engineering/gemini_{technique_name}_responses_{language}.csv"
